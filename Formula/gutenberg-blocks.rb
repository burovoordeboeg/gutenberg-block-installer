class GutenbergBlocks < Formula
  ...
  def install
    system "curl", "-o", "gutenberg-blocks.zip", "-L", "https://github.com/burovoordeboeg/homebrew-gutenberg-block-installer/archive/refs/tags/0.0.13.zip"
    system "unzip", "-q", "gutenberg-blocks.zip"
    bin.install "homebrew-gutenberg-block-installer-0.0.13/scripts/gutenberg-blocks.sh" => "gutenberg-blocks"
  end
end